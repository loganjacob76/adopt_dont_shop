...
RSpec.describe 'admin applicant show page' do
    before :each do
        @john = Applicant.create!(name: 'John Doe', street: '1234 Example Dr.', city: 'Denver', state: 'CO', zip: 12345, personal_statement: 'I love animals and live next to a park.', status: 'Pending')
